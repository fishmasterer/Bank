    ...
    try {
      ...
      switch (selectedFormat) {
        case 'csv':
          ...
          onSuccess(`CSV exported for ${dateLabel}`);
          break;

        case 'excel':
          exportToExcel(expenses, familyMembers, budgets, categoryBudgets, exportOptions);
          onSuccess(`Excel report exported for ${dateLabel}`);
          break;

        case 'pdf':
          exportToPDF(expenses, familyMembers, budgets, categoryBudgets, exportOptions);
          onSuccess(`PDF report exported for ${dateLabel}`);
          break;
